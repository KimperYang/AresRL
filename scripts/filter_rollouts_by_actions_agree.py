...
DEFAULT_DATA_PATH = "data/apigen_with_instruction_full.json.with_gt.filtered.json"
DEFAULT_ROLLOUTS_PATH = "outputs/router_rollouts/sft_router_verify.jsonl"
DEFAULT_OUTPUT_PATH = "outputs/router_rollouts/sft_router_verify.actions_agree.jsonl"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data", default=DEFAULT_DATA_PATH, help="Input data JSON file.")
    parser.add_argument("--rollouts", default=DEFAULT_ROLLOUTS_PATH, help="Input rollouts JSONL file.")
    parser.add_argument("--output", default=DEFAULT_OUTPUT_PATH, help="Output rollouts JSONL file.")
...
def main() -> None:
    ...
    kept_lines = 0
    missing_index = 0
    with open(args.rollouts, "r", encoding="utf-8") as fin, open(
        ...
        json.dumps(
            {
                ...
                "output": args.output,
                "kept_indices": len(keep_indices),
                "total_lines": total_lines,
                "kept_lines": kept_lines,
                "missing_index_lines": missing_index,
            },
            ensure_ascii=True,
            indent=2,
        )
